...
function TermsAndConditions() {
  ...
  return (
    <>
      ...
      {showTerms && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-500 opacity-[95%]">
          <div className="bg-white p-5 max-w-lg w-full rounded-lg shadow-lg relative opacity-100">
            <button
            ...
            <div className="flex flex-col gap-2">
              ...
              <ul className="list-disc text-gray-600 text-sm text-left mt-2 pl-6 flex flex-col gap-1">
