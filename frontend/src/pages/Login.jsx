      ...
      <div className="bg-f5f5f0 w-fit min-h-[60vh] max-h-[80vh] mx-auto my-[50px] flex flex-col gap-2 items-center justify-center px-[30px] shadow-[5px_5px_12px_0px_gray] rounded-lg">
        <form onSubmit={handleSubmit} className="min-w-md max-w-lg mx-auto p-2" >
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              for="floating_email"
              className="peer-focus:font-medium absolute text-md text-gray-600 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:accent peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
             Email address
            </label>
          </div>
