    ...
    <div className="background min-h-screen py-16">
      ...
      >
          <motion.div 
            ...
            className="text-center mb-12 bg-white p-8 rounded-xl shadow-lg border border-e9ecef">
          ...
          <div className="space-y-12">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-gray-700">
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <span className="w-6 h-6 accent text-white rounded-full flex items-center justify-center text-sm">
                        1
                      </span>
                  ...
                  <ul className="space-y-2"> 
                   <li className="flex items-center gap-2">
                    ...
                    <li className="flex items-center gap-2">                     <span className="w-6 h-6 bg-gray-500 text-white rounded-full flex items-center justify-center text-sm">
                        4
                      </span>
            ...
            >
              <div className="flex-shrink-0">
                <FaLeaf className="text-3xl accent" />
              </div>
              <div>
                <h2 className="text-2xl font-semibold text-color mb-3">
                  Sustainability
          ...
          >
            <Link
              to="/register"
              className="inline-block accent hover:secondary text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300"
            >
              Join Our Community
            </Link>
            <div className="mt-8">
